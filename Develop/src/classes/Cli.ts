    ...
    inquirer
      ...
      .then((answers) => {
        ...
        if (answers.action === 'Print details') {
          ...
          for (let i = 0; i < this.vehicles.length; i++) {
            if (this.vehicles[i].vin === this.selectedVehicleVin) {
              const vehicle = this.vehicles[i]; //instatiating the vehcile 

              if (vehicle instanceof Truck) {  // using instance of to validate this is a truck
          ...
          for (let i = 0; i < this.vehicles.length; i++) {
            if (this.vehicles[i].vin === this.selectedVehicleVin) {
              const vehicle = this.vehicles[i]; // instaintiating the vehicle 

              if (vehicle instanceof Motorbike) {  // using instance of to validate this is a motorbike
                vehicle.wheelie(); 
            }
          }
        }
